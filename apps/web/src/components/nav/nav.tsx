import { LucideBookText, LucideSearch, LucideSettings, LucideUsersRound } from 'lucide-react';

import { AccessibleIcon, Button, Seperator, Text } from '@chatse/toolkit';
import { Icon } from '../icon/icon';
import { NavLink } from './nav-link';

export const Nav = () => {
  return (
    <aside className="overflow-auto border-r-2 border-slate-200 bg-slate-50/90 px-3.5 py-4">
      <nav className="flex h-full flex-col space-y-6">
        ...
        <ul className="flex h-full flex-col">
          <li>
            <Text className="mb-2 px-2 text-xs font-semibold uppercase text-slate-700" asChild>
              <h5>General</h5>
            </Text>
            <ul>
              <NavLink href="/clubs">
