  ...
  <li>
    <Link
      ...
      activeProps={{
        ...
        className: cn(
          'text-slate-700',
          'after:absolute after:bottom-[calc(50%-1.875rem)] after:right-1/2 after:h-[2px] after:w-full after:translate-x-[50%] after:translate-y-[-50%] after:bg-blue-700 after:content-[""]',
        ),
      }}
    />
  </li>
