...
import { BookMarked, Earth, Search } from 'lucide-react';

import { AccessibleIcon, Button, Menu, MenuItem, MenuTrigger } from '@chatse/toolkit';
    ...
    <header className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-2">
        <Button
          size="xs"
          variant="outline"
          className="mx-auto gap-0 bg-white font-medium text-slate-500 hover:text-slate-700"
        >
          <Icon className="mr-2">
            <Search />
          </Icon>
        ...
        <MenuTrigger>
          <Button aria-label="Open account menu" className="rounded-full p-0">
            <Avatar
              name="John Doe"
              imageProps={{
                src: 'https://vercel.com/api/www/avatar?u=mrodrigues95&s=64',
  ...
  return (
    <nav aria-label="App Navigation">
      <ul className="flex items-center gap-1">
        <li>
          <Link to="/clubs" variant="default" size="sm" aria-current="page">
            <BookMarked className="size-4" />
            Clubs
          </Link>
        </li>
        <li>
          <Link to="/clubs" variant="ghost" size="sm">
...
const ProtectedLayout = () => (
  <main className="relative flex min-h-screen flex-1 flex-col gap-4 p-4">
    <Header />
    <Nav />
    <Outlet />
  </main>
